...
/* harmony import */ var _math_e6aff5b3_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./math-e6aff5b3.js */ "./node_modules/@esri/calcite-components/dist/esm/math-e6aff5b3.js");
...
const Shell = class {
  constructor(hostRef) {
    ...
    this.handleHeaderSlotChange = (event) => {
      this.hasHeader = !!(0,_dom_f74a09b7_js__WEBPACK_IMPORTED_MODULE_2__.d)(event);
    };
    this.handleFooterSlotChange = (event) => {
      this.hasFooter = !!(0,_dom_f74a09b7_js__WEBPACK_IMPORTED_MODULE_2__.d)(event);
    };
    this.handleAlertsSlotChange = (event) => {
      this.hasAlerts = !!(0,_dom_f74a09b7_js__WEBPACK_IMPORTED_MODULE_2__.d)(event);
      (0,_dom_f74a09b7_js__WEBPACK_IMPORTED_MODULE_2__.s)(event)?.map((el) => {
    ...
    this.handleModalsSlotChange = (event) => {
      this.hasModals = !!(0,_dom_f74a09b7_js__WEBPACK_IMPORTED_MODULE_2__.d)(event);
      (0,_dom_f74a09b7_js__WEBPACK_IMPORTED_MODULE_2__.s)(event)?.map((el) => {
  ...
  // --------------------------------------------------------------------------
  renderHeader() {
    return ((0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { hidden: !this.hasHeader }, (0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", { key: "header", name: SLOTS$2.header, onSlotchange: this.handleHeaderSlotChange })));
  }
  renderFooter() {
    return ((0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: CSS$2.footer, hidden: !this.hasFooter, key: "footer" }, (0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", { name: SLOTS$2.footer, onSlotchange: this.handleFooterSlotChange })));
  }
  renderAlerts() {
    return ((0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { hidden: !this.hasAlerts }, (0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", { key: "alerts", name: SLOTS$2.alerts, onSlotchange: this.handleAlertsSlotChange })));
  }
  renderModals() {
    return ((0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { hidden: !this.hasModals }, (0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", { key: "modals", name: SLOTS$2.modals, onSlotchange: this.handleModalsSlotChange })));
  }
  renderContent() {
    const defaultSlotNode = (0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", { key: "default-slot" });
    const deprecatedCenterRowSlotNode = ((0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", { key: "center-row-slot", name: SLOTS$2.centerRow }));
    const panelBottomSlotNode = (0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", { key: "panel-bottom-slot", name: SLOTS$2.panelBottom });
    const panelTopSlotNode = (0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", { key: "panel-top-slot", name: SLOTS$2.panelTop });
    const contentContainerKey = "content-container";
    const content = !!this.contentBehind
      ? [
        (0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: {
            [CSS$2.content]: true,
            [CSS$2.contentBehind]: true
          }, key: contentContainerKey }, defaultSlotNode),
        (0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: CSS$2.contentBehindCenterContent }, panelTopSlotNode, panelBottomSlotNode, deprecatedCenterRowSlotNode)
      ]
      : [
        (0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: CSS$2.content, key: contentContainerKey }, panelTopSlotNode, defaultSlotNode, panelBottomSlotNode, deprecatedCenterRowSlotNode)
      ];
    return content;
  }
  renderMain() {
    return ((0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: CSS$2.main }, (0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", { name: SLOTS$2.panelStart }), this.renderContent(), (0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", { name: SLOTS$2.panelEnd })));
  }
  renderPositionedSlots() {
    return ((0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: CSS$2.positionedSlotWrapper }, this.renderAlerts(), this.renderModals()));
  }
  render() {
    return ((0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.F, null, this.renderHeader(), this.renderMain(), this.renderFooter(), this.renderPositionedSlots()));
  }
...
const ShellCenterRow = class {
  ...
  render() {
    const { el } = this;
    const contentNode = ((0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: CSS$1.content }, (0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", null)));
    const actionBar = (0,_dom_f74a09b7_js__WEBPACK_IMPORTED_MODULE_2__.g)(el, SLOTS$1.actionBar);
    const actionBarNode = actionBar ? ((0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: CSS$1.actionBarContainer, key: "action-bar" }, (0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", { name: SLOTS$1.actionBar }))) : null;
    const children = [actionBarNode, contentNode];
    if (actionBar?.position === "end") {
      children.reverse();
    }
    return (0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.F, null, children);
  }
  get el() { return (0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.a)(this); }
};
...
const ShellPanel = class {
  constructor(hostRef) {
    ...
    this.separatorPointerMove = (event) => {
      ...
      const adjustmentDirection = layout === "vertical" && (0,_dom_f74a09b7_js__WEBPACK_IMPORTED_MODULE_2__.b)(el) === "rtl" ? -1 : 1;
    ...
    this.separatorPointerUp = (event) => {
      if (!(0,_dom_f74a09b7_js__WEBPACK_IMPORTED_MODULE_2__.i)(event)) {
        return;
      }
      event.preventDefault();
    ...
    this.handleActionBarSlotChange = (event) => {
      const actionBars = (0,_dom_f74a09b7_js__WEBPACK_IMPORTED_MODULE_2__.s)(event).filter((el) => el?.matches("calcite-action-bar"));
  ...
  renderHeader() {
    const { el } = this;
    const hasHeader = (0,_dom_f74a09b7_js__WEBPACK_IMPORTED_MODULE_2__.g)(el, SLOTS.header);
    return hasHeader ? ((0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: CSS.contentHeader, key: "header" }, (0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", { name: SLOTS.header }))) : null;
  }
  render() {
    ...
    const getAnimationDir = () => {
      if (layout === "horizontal") {
        return position === "start"
          ? _resources_d08a6737_js__WEBPACK_IMPORTED_MODULE_6__.C.calciteAnimateInDown
          : _resources_d08a6737_js__WEBPACK_IMPORTED_MODULE_6__.C.calciteAnimateInUp;
      }
      else {
        const isStart = (dir === "ltr" && position === "end") || (dir === "rtl" && position === "start");
        return isStart ? _resources_d08a6737_js__WEBPACK_IMPORTED_MODULE_6__.C.calciteAnimateInLeft : _resources_d08a6737_js__WEBPACK_IMPORTED_MODULE_6__.C.calciteAnimateInRight;
      }
    };
    const contentNode = ((0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: {
        [_resources_d08a6737_js__WEBPACK_IMPORTED_MODULE_6__.C.rtl]: dir === "rtl",
        [CSS.content]: true,
        [CSS.contentOverlay]: displayMode === "overlay",
        [CSS.contentFloat]: displayMode === "float",
        [_resources_d08a6737_js__WEBPACK_IMPORTED_MODULE_6__.C.calciteAnimate]: displayMode === "overlay",
        [getAnimationDir()]: displayMode === "overlay"
      }, hidden: collapsed, key: "content", style: style,
      // eslint-disable-next-line react/jsx-sort-props
      ref: this.storeContentEl }, this.renderHeader(), (0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: CSS.contentBody }, (0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", null)), separatorNode));
    const actionBarNode = ((0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", { key: "action-bar", name: SLOTS.actionBar, onSlotchange: this.handleActionBarSlotChange }));
    const mainNodes = [actionBarNode, contentNode];
    if (position === "end") {
      mainNodes.reverse();
    }
    return (0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: { [CSS.container]: true } }, mainNodes);
  }
  // --------------------------------------------------------------------------
  //
  //  private Methods
  ...
  setContentWidth(width) {
    ...
    this.contentWidth =
      typeof contentWidthMax === "number" && typeof contentWidthMin === "number"
        ? (0,_math_e6aff5b3_js__WEBPACK_IMPORTED_MODULE_4__.c)(roundedWidth, contentWidthMin, contentWidthMax)
        : roundedWidth;
  }
  updateAriaValues() {
    ...
    (0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.f)(this);
  }
  setContentHeight(height) {
    ...
    this.contentHeight =
      typeof contentHeightMax === "number" && typeof contentHeightMin === "number"
        ? (0,_math_e6aff5b3_js__WEBPACK_IMPORTED_MODULE_4__.c)(roundedWidth, contentHeightMin, contentHeightMax)
        : roundedWidth;
  }
