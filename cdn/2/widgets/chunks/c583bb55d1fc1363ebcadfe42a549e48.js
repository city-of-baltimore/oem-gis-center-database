...
function watchGlobalAttributes(component, attributeFilter) {
  ...
  if (!mutationObserver) {
    mutationObserver = (0,_observers_c20ec2dd_js__WEBPACK_IMPORTED_MODULE_5__.c)("mutation", processMutations);
  }
...
const CalciteMenu = class {
  constructor(hostRef) {
    ...
    this.handleMenuSlotChange = (event) => {
      this.menuItems = (0,_dom_f74a09b7_js__WEBPACK_IMPORTED_MODULE_1__.s)(event);
  ...
  calciteInternalNavMenuItemKeyEvent(event) {
    ...
    if (key === "ArrowDown") {
      if (target.layout === "vertical") {
        (0,_dom_f74a09b7_js__WEBPACK_IMPORTED_MODULE_1__.j)(this.menuItems, target, "next", false);
      }
      else {
      ...
      if (this.layout === "vertical") {
        (0,_dom_f74a09b7_js__WEBPACK_IMPORTED_MODULE_1__.j)(this.menuItems, target, "previous", false);
      }
      else {
        if (event.detail.isSubmenuOpen) {
  ...
  focusParentElement(el) {
    ...
    if (parentEl) {
      (0,_dom_f74a09b7_js__WEBPACK_IMPORTED_MODULE_1__.f)(parentEl);
      parentEl.open = false;
    }
  }
  ...
  // --------------------------------------------------------------------------
  render() {
    return ((0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("ul", { "aria-label": this.label, ...this.globalAttributes }, (0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", { onSlotchange: this.handleMenuSlotChange }))));
  }
...
const CalciteMenuItem = class {
  constructor(hostRef) {
    (0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.r)(this, hostRef);
    this.calciteInternalMenuItemKeyEvent = (0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.c)(this, "calciteInternalMenuItemKeyEvent", 7);
    this.calciteMenuItemSelect = (0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.c)(this, "calciteMenuItemSelect", 7);
    ...
    this.handleMenuItemSlotChange = (event) => {
      this.submenuItems = (0,_dom_f74a09b7_js__WEBPACK_IMPORTED_MODULE_1__.s)(event);
  ...
  //--------------------------------------------------------------------------
  renderIconStart() {
    return ((0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("calcite-icon", { class: `${CSS.icon} ${CSS.iconStart}`, flipRtl: this.iconFlipRtl === "start" || this.iconFlipRtl === "both", icon: this.iconStart, key: CSS.iconStart, scale: "s" }));
  }
  renderIconEnd() {
    return ((0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("calcite-icon", { class: `${CSS.icon} ${CSS.iconEnd}`, flipRtl: this.iconFlipRtl === "end" || this.iconFlipRtl === "both", icon: this.iconEnd, key: CSS.iconEnd, scale: "s" }));
  }
  renderBreadcrumbIcon(dir) {
    return ((0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("calcite-icon", { class: `${CSS.icon} ${CSS.iconBreadcrumb}`, icon: dir === "rtl" ? "chevron-left" : "chevron-right", key: CSS.iconBreadcrumb, scale: "s" }));
  }
  renderDropdownIcon(dir) {
    const dirChevron = dir === "rtl" ? "chevron-left" : "chevron-right";
    return ((0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("calcite-icon", { class: `${CSS.icon} ${CSS.iconDropdown}`, icon: this.topLevelMenuLayout === "vertical" || this.isTopLevelItem
        ? this.open
          ? "chevron-up"
          : "chevron-down"
  ...
  renderDropdownAction(dir) {
    const dirChevron = dir === "rtl" ? "chevron-left" : "chevron-right";
    return ((0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("calcite-action", { class: CSS.dropdownAction, icon: this.topLevelMenuLayout === "vertical" || this.isTopLevelItem
        ? this.open
          ? "chevron-up"
          : "chevron-down"
  ...
  renderSubmenuItems(dir) {
    return ((0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("calcite-menu", { class: {
      ...
      }, label: this.messages.submenu, layout: "vertical", role: "menu" }, (0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", { name: "submenu-item", onSlotchange: this.handleMenuItemSlotChange })));
  }
  renderItemContent(dir) {
    return ((0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.F, null, this.iconStart && this.renderIconStart(), (0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: CSS.textContainer }, (0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", null, this.text)), !this.href && this.hasSubmenu ? this.renderDropdownIcon(dir) : null, this.breadcrumb ? this.renderBreadcrumbIcon(dir) : null, this.iconEnd && this.renderIconEnd()));
  }
  render() {
    const dir = (0,_dom_f74a09b7_js__WEBPACK_IMPORTED_MODULE_1__.b)(this.el);
    return ((0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.H, { onBlur: this.blurHandler, onFocus: this.focusHandler }, (0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("li", { class: {
        [CSS.container]: true,
        [CSS.isParentVertical]: this.topLevelMenuLayout === "vertical"
      }, role: "none" }, (0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: CSS.itemContent }, (0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("a", { "aria-current": this.isFocused ? "page" : false, "aria-expanded": this.open, "aria-haspopup": this.hasSubmenu, "aria-label": this.label, class: { [CSS.layoutVertical]: this.layout === "vertical", [CSS.content]: true }, href: this.href, onClick: this.clickHandler, onKeyDown: this.keyDownHandler, rel: this.rel, role: "menuitem", tabIndex: this.isTopLevelItem ? 0 : -1, target: this.target,
      // eslint-disable-next-line react/jsx-sort-props
      ref: (el) => (this.anchorEl = el) }, this.renderItemContent(dir), this.href && (this.topLevelMenuLayout === "vertical" || !this.isTopLevelItem) ? ((0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("calcite-icon", { class: CSS.hoverHrefIcon, icon: dir === "rtl" ? "arrow-left" : "arrow-right", scale: "s" })) : null), this.href && this.hasSubmenu ? this.renderDropdownAction(dir) : null), this.renderSubmenuItems(dir))));
  }
  static get assetsDirs() { return ["assets"]; }
  get el() { return (0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.a)(this); }
  static get watchers() { return {
