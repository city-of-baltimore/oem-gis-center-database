...
/* harmony import */ var _utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils-85b95e46.js */ "./node_modules/@esri/calcite-components/dist/esm/utils-85b95e46.js");
...
/* harmony import */ var _observers_95e97fae_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./observers-95e97fae.js */ "./node_modules/@esri/calcite-components/dist/esm/observers-95e97fae.js");
...
const ColorPicker = class {
  constructor(hostRef) {
    ...
    this.mode = _utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.C.HEX;
    ...
    this.handleHexInputChange = (event) => {
      ...
      const normalizedHex = color$1 && (0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.n)((0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.a)(color$1, (0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.c)(this.mode)));
    ...
    this.handleChannelChange = (event) => {
      ...
      const isAlphaChannel = channelIndex === 3;
      const value = Number(input.value);
      channels[channelIndex] = isAlphaChannel ? (0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.o)(value) : value;
    ...
    this.renderChannelsTab = (channelMode) => {
      ...
      return ((0,_index_c7e05e63_js__WEBPACK_IMPORTED_MODULE_0__.h)("calcite-tab", { class: CSS$2.control, key: channelMode, selected: selected }, (0,_index_c7e05e63_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: CSS$2.channels, dir: "ltr" }, channelsToRender.map((channelValue, index) => {
        ...
        if (isAlphaChannel) {
          channelValue =
            allowEmpty && !channelValue ? channelValue : (0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.b)(channelValue);
        }
    ...
    this.deleteColor = () => {
      const colorToDelete = (0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.a)(this.color, this.alphaChannel);
    ...
    this.saveColor = () => {
      const colorToSave = (0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.a)(this.color, this.alphaChannel);
    ...
    this.drawColorControls = (0,_throttle_b7008174_js__WEBPACK_IMPORTED_MODULE_9__.t)((type = "all") => {
    ...
    this.handleOpacityScopeKeyDown = (event) => {
      ...
      if (arrowKeyToXOffset[key]) {
        event.preventDefault();
        const delta = (0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.o)(arrowKeyToXOffset[key] * modifier);
    ...
    this.value = (0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.n)((0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.a)(DEFAULT_COLOR$1, this.alphaChannel));
  ...
  handleAlphaChannelChange(alphaChannel) {
    const { format } = this;
    if (alphaChannel && format !== "auto" && !(0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.c)(format)) {
  ...
  handleValueChange(value, oldValue) {
    ...
    if (checkMode) {
      const nextMode = (0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.p)(value);
    ...
    const color$1 = allowEmpty && !value
      ? null
      : color(value != null && typeof value === "object" && (0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.c)(this.mode)
        ? (0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.g)(value)
        : value);
    const colorChanged = !(0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.d)(color$1, this.color);
  ...
  async componentWillLoad() {
    ...
    const parsedMode = (0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.p)(value);
  ...
  render() {
    ...
    const selectedColorInHex = color ? (0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.a)(color, alphaChannel) : null;
    const hueTop = thumbRadius;
    const hueLeft = hueScopeLeft ?? (sliderWidth * DEFAULT_COLOR$1.hue()) / HSV_LIMITS.h;
    const opacityTop = thumbRadius;
    const opacityLeft = opacityScopeLeft ??
      (colorFieldWidth * (0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.b)(DEFAULT_COLOR$1.alpha())) / OPACITY_LIMITS.max;
  ...
  ensureCompatibleMode(mode, warn) {
    ...
    const isAlphaCompatible = (0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.c)(mode);
    if (alphaChannel && !isAlphaCompatible) {
      const alphaMode = (0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.f)(mode);
      if (warn) {
    ...
    if (!alphaChannel && isAlphaCompatible) {
      const nonAlphaMode = (0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.t)(mode);
      if (warn) {
  ...
  captureOpacitySliderValue(x) {
    const { dimensions: { slider: { width } } } = this;
    const alpha = (0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.o)((OPACITY_LIMITS.max / width) * x);
    this.internalColorSet(this.baseColorFieldColor.alpha(alpha), false);
  }
  internalColorSet(color, skipEqual = true, context = "user-interaction") {
    if (skipEqual && (0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.d)(color, this.color)) {
      return;
    }
  ...
  toValue(color, format = this.mode) {
    ...
    if (format.includes(hexMode)) {
      const hasAlpha = format === _utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.C.HEXA;
      return (0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.n)((0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.a)(color.round(), hasAlpha), hasAlpha);
    }
    ...
    color[(0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.t)(format)]().round().object();
    if (format.endsWith("a")) {
      return (0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.e)(colorObject);
    }
    return colorObject;
  }
  getSliderCapSpacing() {
  ...
  drawActiveOpacitySliderColor() {
    ...
    const x = (0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.b)(hsvColor.alpha()) / (OPACITY_LIMITS.max / width);
    const y = radius;
    requestAnimationFrame(() => {
...
const ColorPickerHexInput = class {
  constructor(hostRef) {
    ...
    this.onHexInputBlur = () => {
      ...
      const isLonghand = (0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.j)(hex);
      // ensure modified pasted hex values are committed since we prevent default to remove the # char.
      this.onHexInputChange();
      if (willClearValue || ((0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.i)(hex) && isLonghand)) {
        return;
      }
      ...
      node.value =
        allowEmpty && !internalColor
          ? ""
          : this.formatHexForInternalInput((0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.r)(
    ...
    this.onHexInputChange = () => {
      ...
      let value = nodeValue;
      if (value) {
        const normalized = (0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.n)(value, false);
        const preserveExistingAlpha = (0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.i)(normalized) && this.alphaChannel;
        if (preserveExistingAlpha && this.internalColor) {
          const alphaHex = (0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.n)(this.internalColor.hexa(), true).slice(-2);
    ...
    this.onOpacityInputChange = () => {
      ...
      if (!node.value) {
        ...
        const alpha = (0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.o)(Number(node.value));
    ...
    this.onInputKeyDown = (event) => {
      ...
      if (isNudgeKey) {
        ...
        this.internalSetValue((0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.a)(this.nudgeRGBChannels(internalColor, bump * direction, composedPath.includes(hexInputNode) ? "rgb" : "a"), alphaChannel), oldValue);
        event.preventDefault();
        return;
      }
      const withModifiers = altKey || ctrlKey || metaKey;
      const singleChar = key.length === 1;
      const validHexChar = _utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.k.test(key);
    ...
    this.onHexInputPaste = (event) => {
      ...
      if ((0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.i)(hex)) {
        event.preventDefault();
    ...
    this.numberingSystem = undefined;
    this.scale = "m";
    this.value = (0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.n)((0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.a)(DEFAULT_COLOR, this.alphaChannel), this.alphaChannel, true);
  ...
  connectedCallback() {
    ...
    if (value) {
      const normalized = (0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.n)(value, alphaChannel);
      if ((0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.i)(normalized, alphaChannel)) {
  ...
  internalSetValue(value, oldValue, emit = true) {
    if (value) {
      const { alphaChannel } = this;
      const normalized = (0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.n)(value, alphaChannel, alphaChannel);
      if ((0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.i)(normalized, alphaChannel)) {
        const { internalColor: currentColor } = this;
        const nextColor = color(normalized);
        const normalizedLonghand = (0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.n)((0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.a)(nextColor, alphaChannel), alphaChannel);
        const changed = !currentColor ||
          normalizedLonghand !== (0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.n)((0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.a)(currentColor, alphaChannel), alphaChannel);
  ...
  formatOpacityForInternalInput(color) {
    return color ? `${(0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.b)(color.alpha())}` : "";
  }
  nudgeRGBChannels(color$1, amount, context) {
    ...
    if (context === "rgb") {
      ...
      const nudgedAlpha = (0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.o)((0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.b)(color$1.alpha()) + amount);
...
const ColorPickerSwatch = class {
  ...
  renderSwatch() {
    ...
    const hex = (0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.a)(internalColor);
    const hexa = (0,_utils_85b95e46_js__WEBPACK_IMPORTED_MODULE_2__.a)(internalColor, alpha < 1);
...
/***/ "./node_modules/@esri/calcite-components/dist/esm/utils-85b95e46.js":
/*!**************************************************************************!*\
  !*** ./node_modules/@esri/calcite-components/dist/esm/utils-85b95e46.js ***!
  \**************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
