"use strict";
(self["webpackChunkexb_client"] = self["webpackChunkexb_client"] || []).push([["vendors-node_modules_esri_calcite-components_dist_esm_focusTrapComponent-b3a29d9c_js-node_mod-8d0184"],{

/***/ "./node_modules/@esri/calcite-components/dist/esm/focusTrapComponent-b3a29d9c.js":
/*!***************************************************************************************!*\
  !*** ./node_modules/@esri/calcite-components/dist/esm/focusTrapComponent-b3a29d9c.js ***!
  \***************************************************************************************/
...
var createFocusTrap = function createFocusTrap(elements, userOptions) {
  ...
  var updateTabbableNodes = function updateTabbableNodes() {
    state.containerGroups = state.containers.map(function (container) {
      var tabbableNodes = (0,_dom_f74a09b7_js__WEBPACK_IMPORTED_MODULE_0__.k)(container, config.tabbableOptions);

      // NOTE: if we have tabbable nodes, we must have focusable nodes; focusable nodes
      //  are a superset of tabbable nodes
      var focusableNodes = (0,_dom_f74a09b7_js__WEBPACK_IMPORTED_MODULE_0__.l)(container, config.tabbableOptions);
      return {
        container: container,
        ...
        nextTabbableNode: function nextTabbableNode(node) {
          ...
          if (forward) {
            return focusableNodes.slice(nodeIdx + 1).find(function (n) {
              return (0,_dom_f74a09b7_js__WEBPACK_IMPORTED_MODULE_0__.m)(n, config.tabbableOptions);
            });
          }
  ...
  var checkKeyNav = function checkKeyNav(event) {
    ...
    if (state.tabbableGroups.length > 0) {
      ...
      if (containerIndex < 0) {
        ...
        if (startOfGroupIndex < 0 && (containerGroup.container === target || (0,_dom_f74a09b7_js__WEBPACK_IMPORTED_MODULE_0__.n)(target, config.tabbableOptions) && !(0,_dom_f74a09b7_js__WEBPACK_IMPORTED_MODULE_0__.m)(target, config.tabbableOptions) && !containerGroup.nextTabbableNode(target, false))) {
        ...
        if (lastOfGroupIndex < 0 && (containerGroup.container === target || (0,_dom_f74a09b7_js__WEBPACK_IMPORTED_MODULE_0__.n)(target, config.tabbableOptions) && !(0,_dom_f74a09b7_js__WEBPACK_IMPORTED_MODULE_0__.m)(target, config.tabbableOptions) && !containerGroup.nextTabbableNode(target))) {
...
function connectFocusTrap(component, options) {
  ...
  const focusTrapOptions = {
    ...
    setReturnFocus: (el) => {
      (0,_dom_f74a09b7_js__WEBPACK_IMPORTED_MODULE_0__.f)(el);
      return false;
    },
    ...options?.focusTrapOptions,
    // the following options are not overrideable
    document: el.ownerDocument,
    tabbableOptions: _dom_f74a09b7_js__WEBPACK_IMPORTED_MODULE_0__.o,
    trapStack
  };
