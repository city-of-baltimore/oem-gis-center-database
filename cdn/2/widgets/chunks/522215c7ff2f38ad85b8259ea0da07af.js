...
const TipManager = class {
  ...
  async effectiveLocaleChange() {
    await (0,_t9n_fac13394_js__WEBPACK_IMPORTED_MODULE_4__.u)(this, this.effectiveLocale);
    this.updateGroupTitle();
  }
  // --------------------------------------------------------------------------
  //
