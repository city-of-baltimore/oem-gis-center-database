"use strict";
(self["webpackChunkexb_client"] = self["webpackChunkexb_client"] || []).push([["vendors-node_modules_esri_calcite-components_dist_esm_ExpandToggle-b2d209dd_js-node_modules_e-66e1d5"],{

/***/ "./node_modules/@esri/calcite-components/dist/esm/ExpandToggle-b2d209dd.js":
/*!*********************************************************************************!*\
  !*** ./node_modules/@esri/calcite-components/dist/esm/ExpandToggle-b2d209dd.js ***!
  \*********************************************************************************/
...
/* harmony import */ var _resources_b24eb444_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./resources-b24eb444.js */ "./node_modules/@esri/calcite-components/dist/esm/resources-b24eb444.js");
/* harmony import */ var _resources_2cb98f22_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./resources-2cb98f22.js */ "./node_modules/@esri/calcite-components/dist/esm/resources-2cb98f22.js");
/*!
...
const queryActions = (el) => {
  return Array.from(el.querySelectorAll("calcite-action")).filter((action) => action.closest("calcite-action-menu") ? action.slot === _resources_2cb98f22_js__WEBPACK_IMPORTED_MODULE_3__.S.trigger : true);
};
const overflowActions = ({ actionGroups, expanded, overflowCount }) => {
  ...
  actionGroups.reverse().forEach((group) => {
    ...
    groupActions.forEach((groupAction) => {
      if (groupAction.slot === _resources_b24eb444_js__WEBPACK_IMPORTED_MODULE_2__.S.menuActions) {
    ...
    if (needToSlotCount > 0) {
      groupActions.some((groupAction) => {
        ...
        if (unslottedActions.length > 1 && groupActions.length > 2 && !groupAction.closest("calcite-action-menu")) {
          ...
          groupAction.setAttribute("slot", _resources_b24eb444_js__WEBPACK_IMPORTED_MODULE_2__.S.menuActions);
    ...
    (0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.f)(group);
  });
};
...
function toggleChildActionText({ parent, expanded }) {
  queryActions(parent)
    .filter((el) => el.slot !== _resources_b24eb444_js__WEBPACK_IMPORTED_MODULE_2__.S.menuActions)
...
const ExpandToggle = ({ expanded, intlExpand, intlCollapse, toggle, el, position, tooltip, ref, scale }) => {
  ...
  const actionNode = ((0,_index_a6760286_js__WEBPACK_IMPORTED_MODULE_0__.h)("calcite-action", { icon: expanded ? expandIcon : collapseIcon, onClick: toggle, scale: scale, text: expandText, textEnabled: expanded, 
